...
<body style="background-color: white;">
  ...
  <div class="container" style="background-color:#f3f3f3;">
    <div class="row header">
          <h2 style="color:#b40032;">Edit Foreign SIM User Information</h2>
        </div>
...
<form class="" action="admin_edit_selected_user/admin_back_foreign_user.php?simnum=<?php echo $throw ?>" method="POST" enctype="multipart/form-data">
    ...
    if (mysqli_num_rows($result) > 0) {
       ...
       <div class="row srow">
         <div class="col-md-12 ">
           ...
           <input type="text" required name="passnum" class="form-control" value="<?= $row['passnum'] ?>" disabled>
         </div>
       </div>
