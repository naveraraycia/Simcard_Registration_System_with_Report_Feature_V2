...
<body style="background-color: white;">
  ...
  <div class="row">
    <div class="col-md-12">
    <p class="header row-head" style="margin-bottom: 0px; display: flex; justify-content: center;color: #b40032;">LIST OF WORK SIMS REQUEST FOR INFO UPDATE</p>
    </div>
  </div>
  ...
  <table class="table table-striped" id="example">
    <thead>
      <tr>
        ...
        <th class="f-column text-truncate" scope="col" >NSO Proof</th>
        <th class="f-column text-truncate" scope="col" >Valid ID Proof</th>
        <th class="f-column text-truncate" scope="col" >Business Permit Proof</th>
