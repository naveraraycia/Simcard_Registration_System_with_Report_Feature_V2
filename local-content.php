        ...
        <div class="container" style="background-color:#f3f3f3;">
          <div class="row" style="margin-bottom:1rem;">
            ...
            <div class="col-md-6">
              ...
              <div class="infolabels">
                <p class="nameLabel">Address: <span>Planet Earth</span></p>
              </div>
              <div class="infolabels">
                <p class="nameLabel">NSO #: <span>TEST-1234-NSO</span></p>
              </div>
              <div class="infolabels">
        ...
        if (isset($_GET['additionalLocal'])) {
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="infolabels">
                <br>
                <p class="nameLabel">Reason for acquiring additional SIM to similar provider: <span style="display:block;">This is the reason.....</span></p>
              </div>
            </div>
          </div>
          <?php
