...
<body style="background-color: white;">
  ...
  <div class="row">
    <div class="col-md-12">
    <p class="header row-head" style="margin-bottom: 0px; display: flex; justify-content: center;color: #b40032;">LIST OF LOCAL AND FOREIGN USER REQUEST FOR INFO UPDATE</p>
    </div>
  </div>
