...
If the Documents on SimCardRegistrationSystem’s official printed documents differs from the information contained on the SimCardRegistrationSystem website, the information on SimCardRegistrationSystem's official printed documents will take precedence.
</p>
</div>
    ...
    <p class="information" style="line-height: 200%;color:black!important;">Certain portions of the SimCardRegistrationSystem website are limited to registered users and/or allow a user to request support or services online by entering personal information. You agree that any information provided to us in these areas will be complete and accurate, that you will not register under the name of, nor attempt to enter the SimCardRegistrationSystem website under the name of, another person.
Each registration is for your personal use only. You are responsible to prevent unauthorized use of the SimCardRegistrationSystem website using your registration information. You are entirely responsible for maintaining the confidentiality of your key and account. Furthermore, you are entirely responsible for any and all activities that occur under your account.
You agree to notify SimCardRegistrationSystem immediately of any unauthorized use of your account or any other breach of security. SimCardRegistrationSystem will not be liable for any loss that you may incur as a result of someone else using your key or account, either with or without your knowledge. However, you could be held liable for losses incurred by SimCardRegistrationSystem or another party due to someone else using your account or key. You may not use anyone else’s account at any time, without the permission of the account holder.</p>
</div>
    ...
    <p class="information" style="line-height: 200%;color:black!important;">Your right to use the SimCardRegistrationSystem website is assignable to your SIM retailers. Though the account is accessible to your employees, the unique key you have provided during your registration with the administrator is non-transferable and nor assignable.</p>
  </div>
