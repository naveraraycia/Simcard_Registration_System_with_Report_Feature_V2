  ...
  <body style="background-color: white;">
    ...
    <div class="container" style="background-color: #f3f3f3;">
      <div class="row header">
          ...
          <form class="" action="duplicate-business-verify.php" method="GET">
<?php
...
// ========================================================== NAG PRESS NA =========================================================
  if(isset($_GET['nsonum'])){
    ...
    if (mysqli_num_rows($result) > 0) {
      ...
      if($checkbanstat ==  "ban"){
        header("Location: ../Simcard_Registration_System_with_Report_Feature_V2/duplicate-business-verify.php?stillban");
        exit();
      }else if($checkbanstat == "permanentban"){
        header("Location: ../Simcard_Registration_System_with_Report_Feature_V2/duplicate-business-verify.php?permanentban");
        exit();
      }

      $exceed= checkPenalty($conn,$nso);
      if($exceed == true){
        header("Location: ../Simcard_Registration_System_with_Report_Feature_V2/duplicate-business-verify.php?exceed");
        exit();
      }
        ...
        <div class="row srow nsobutton" style="display:none;">
          ...
          <button type="submit" name="button" class="send-btn db" onclick="duplicate-business-verify.php">Search Database</button>
        </div>
...
<div class="row" style="margin-top: 2rem;">
  ...
  <div class="col-6 infodiv" style="padding-left: 0px;">
    ...
    header("Location: ../Simcard_Registration_System_with_Report_Feature_V2/duplicate-business-verify.php?no-result=nsonum='.$nso.'&button");
    // echo "NO RESULT";
