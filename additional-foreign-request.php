<?php
  require 'includes/dbh.inc.php';
   $sql = "SELECT * FROM request_reg_db WHERE NOT nationality = N'Filipino'
    ...
    <?php
       if (isset($_GET['filters'])){
        ...
        if (empty($end_date)){
          ...
          $sql = "SELECT * FROM request_reg_db WHERE NOT nationality = N'Filipino' AND dateofregis BETWEEN '$start_date' AND '$end_date'
          ORDER BY lastname ASC";
          $result = mysqli_query($conn, $sql);
      ...
      <tr>
        ...
        <td class="text-truncate"><a href="additional_approve/deleteforeign.php?request=<?php echo   $thrownum; ?>" class="btn btn-danger">Deny</a></td>
