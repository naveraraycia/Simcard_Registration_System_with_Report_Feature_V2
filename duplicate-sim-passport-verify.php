  ...
  <body style="background-color: white;">
    ...
    <div class="container" style="background-color: #f3f3f3;">
      <div class="row header">
            <h2>Verify Passport Document for Applicant applying for duplicate SIM provider</h2>
          </div>

          <form class="" action="duplicate-sim-passport-verify.php" method="GET">
<?php
    ...
    $result = mysqli_query($conn,$query);
      ...
      if (mysqli_num_rows($result) > 0) {
        ...
        <div class="row srow nsobutton" style="display:none;">
          ...
          <button type="submit" name="button" class="send-btn db" onclick="duplicate-sim-passport-verify.php">Search Database</button>
        </div>
...
<div class="row" style="margin-top: 2rem;">
  <div class="col-6 infodiv" style="padding-left: 0px;">
    <a href="duplicate-sim-passport-verify.php">
    <button type="submit" name="button" class="send-btn db" onclick="duplicate-sim-passport-verify.php" >Go back</button></a>
</div>

  <div class="col-6 infodiv" style="padding-left: 0px;">
    <a href="register-duplicate-sim-foreign.php">
    <button type="submit" name="button" class="send-btn db" onclick="register-duplicate-sim-foreign.php" >Proceed to registration</button></a>
</div>
    ...
    header("Location: ../Simcard_Registration_System_with_Report_Feature_V2/duplicate-sim-passport-verify.php?no-result=nsonum='.$passport.'&button");
...
?>
<form class="" action="register-duplicate-sim-foreign.php" method="GET">
