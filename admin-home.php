...
<div class="row">
  ...
  <div class="col-md-3">
    <a href="#"><button type="button" name="button" class="send-btn">Register SIM retailer</button></a>
  </div>
...
<div class="row">
  <div class="col-md-6">
    <a href="#"><button type="button" name="button" class="send-btn">View / Update / Delete registered SIM User</button></a>
  </div>
