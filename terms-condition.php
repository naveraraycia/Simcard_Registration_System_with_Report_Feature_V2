...
Each registration is for your personal use only. You are responsible to prevent unauthorized use of the SimCardRegistrationSystem website using your registration information. You are entirely responsible for maintaining the confidentiality of your OTP and account. Furthermore, you are entirely responsible for any and all activities that occur under your account.
You agree to notify SimCardRegistrationSystem immediately of any unauthorized use of your account or any other breach of security. SimCardRegistrationSystem will not be liable for any loss that you may incur as a result of someone else using your OTP or account, either with or without your knowledge. However, you could be held liable for losses incurred by SimCardRegistrationSystem or another party due to someone else using your account or OTP. You may not use anyone else’s account at any time, without the permission of the account holder.</p>
    ...
    <br>
    <div class="" style="display:flex;flex-direction:column;">
    <h2>9. Non-transferable</h2>
    <p class="information" style="line-height: 200%;color:black!important;">Your right to use the SimCardRegistrationSystem website is not transferable or assignable. Any OTP or right given to you is not transferable or assignable.</p>
  </div>
